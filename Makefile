...
compiler: ./src/Main.hs ${synthesisSources} ${parserSources} ${interludeSources}
	ghc --make -isrc/Frontend/Parser:src/Frontend/Synthesis:src/Interlude ./src/Main.hs -o latc
