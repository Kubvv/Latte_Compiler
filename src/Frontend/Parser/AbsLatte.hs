...
data TopDef' a
    ...
    | ClsDef a Ident (ClsInh' a) [ClsElemDef' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type ClsInh = ClsInh' BNFC'Position
data ClsInh' a = NoInh a | Inh a Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Arg = Arg' BNFC'Position
data Arg' a = VArg a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type ClsElemDef = ClsElemDef' BNFC'Position
data ClsElemDef' a
    = MetDef a (Type' a) Ident [Arg' a] (Block' a)
    | AtrDef a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Type' a = Var a | Arr a (Type' a) | Cls a Ident | Void a
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Expr' a
    ...
    | ELitTrue a
    | ELitFalse a
    | EArrAcs a (Expr' a) (Expr' a)
    | EApp a (Expr' a) [Expr' a]
    | EELem a (Expr' a) Ident
...
instance HasPosition ClsInh where
  hasPosition = \case
    NoInh p -> p
    Inh p _ -> p
...
instance HasPosition ClsElemDef where
  hasPosition = \case
    MetDef p _ _ _ _ -> p
    AtrDef p _ _ -> p
