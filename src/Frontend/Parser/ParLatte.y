...
Program
  : ListTopDef { (fst $1, AbsLatte.PProgram (fst $1) (snd $1)) }

TopDef :: { (AbsLatte.BNFC'Position, AbsLatte.TopDef) }
TopDef
  : Type Ident '(' ListArg ')' Block { (fst $1, AbsLatte.FnDef (fst $1) (snd $1) (snd $2) (snd $4) (snd $6)) }
  | 'class' Ident ClsInh '{' ListClsElemDef '}' { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.ClsDef (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3) (snd $5)) }
...
ClsInh :: { (AbsLatte.BNFC'Position, AbsLatte.ClsInh) }
ClsInh
  : {- empty -} { (AbsLatte.BNFC'NoPosition, AbsLatte.NoInh AbsLatte.BNFC'NoPosition) }
  | 'extends' Ident { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.Inh (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2)) }

Arg :: { (AbsLatte.BNFC'Position, AbsLatte.Arg) }
Arg
  : Type Ident { (fst $1, AbsLatte.VArg (fst $1) (snd $1) (snd $2)) }
...
ClsElemDef :: { (AbsLatte.BNFC'Position, AbsLatte.ClsElemDef) }
ClsElemDef
  : Type Ident '(' ListArg ')' Block { (fst $1, AbsLatte.MetDef (fst $1) (snd $1) (snd $2) (snd $4) (snd $6)) }
  | Type Ident ';' { (fst $1, AbsLatte.AtrDef (fst $1) (snd $1) (snd $2)) }

ListClsElemDef :: { (AbsLatte.BNFC'Position, [AbsLatte.ClsElemDef]) }
ListClsElemDef
  : {- empty -} { (AbsLatte.BNFC'NoPosition, []) }
  | ClsElemDef ListClsElemDef { (fst $1, (:) (snd $1) (snd $2)) }

Block :: { (AbsLatte.BNFC'Position, AbsLatte.Block) }
Block
  : '{' ListStmt '}' { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.BBlock (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2)) }
...
Type
  : 'var' { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.Var (uncurry AbsLatte.BNFC'Position (tokenLineCol $1))) }
  | Type '[]' { (fst $1, AbsLatte.Arr (fst $1) (snd $1)) }
  | Ident { (fst $1, AbsLatte.Cls (fst $1) (snd $1)) }
...
Expr7
  : '(' Ident ')' Expr6 { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.ECast (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $4)) }
...
Expr6
  ...
  | Expr6 '[' Expr ']' { (fst $1, AbsLatte.EArrAcs (fst $1) (snd $1) (snd $3)) }
  | Expr6 '(' ListExpr ')' { (fst $1, AbsLatte.EApp (fst $1) (snd $1) (snd $3)) }
  | Expr6 '.' Ident { (fst $1, AbsLatte.EELem (fst $1) (snd $1) (snd $3)) }
  | 'new' Type '[' Expr ']' { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.ENewArr (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $4)) }
  | 'new' Type { (uncurry AbsLatte.BNFC'Position (tokenLineCol $1), AbsLatte.ENew (uncurry AbsLatte.BNFC'Position (tokenLineCol $1)) (snd $2)) }
